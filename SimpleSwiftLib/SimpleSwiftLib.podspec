...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SimpleSwiftLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/elye/SimpleSwiftLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'elye' => 'elisha.lye@rea.group.com' }
  s.source           = { :git => 'https://github.com/elye/SimpleSwiftLib.git', :tag => s.version.to_s }
