...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SimpleViewLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/elye/SimpleViewLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'elye' => 'elisha.lye@rea.group.com' }
  s.source           = { :git => 'https://github.com/elye/SimpleViewLib.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '13.0'

  s.source_files = 'SimpleViewLib/Classes/**/*'
  s.dependency 'SimpleSwiftLib', '0.1.0'
  # s.resource_bundles = {
